...
@return Anwer #true when the print operation was succesful and #false otherwise
				...
				if (document.message_.startsWith("!PS")) {
					...
					if (startPos >= 0) {
						...
						if (startPos >= 0) {
							...
							extractedAccounting(report, author, title);
	...
	private void extractedAccounting(Writer report, String author, String title) throws IOException {
...
<p><strong>Precondition:</strong> isInitialized();</p>
	...
	public void printOn (StringBuffer buf) {
		...
		Node currentNode = firstNode_;
		do {
			extractedSwitch(buf, currentNode);
			buf.append(" -> ");
			currentNode = currentNode.nextNode_;
	...
	private void extractedSwitch(StringBuffer buf, Node currentNode) {
